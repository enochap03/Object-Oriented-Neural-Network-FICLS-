...
// Test class examines the result of training with the finally stores weight matrix
public class Test {
 ...
 // load input and actual output from file for testing
	...
	// test() methods examines  the trained result
