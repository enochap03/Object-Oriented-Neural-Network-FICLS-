...
import implayout.TestResultFormationWithFileName;
import plot.SaveLoadPlotParametersDetails;

public class FindConvergencePosition {
	...
	public static int getConvergingPosition(double[] arr) {
	...
	public static int getConvergingSameSignPosition(double[] arr) {
	
		boolean isPositiveSign = false;
		int startPos = 0;
		if(arr[0]>0) {
			isPositiveSign = true;
	...
	public static void main(String args[]) throws IOException {
		...
		String res [] = TestResultFormationWithFileName.getResult(compWeightName);
